...
@section ('contenido')
    <div class="row">
        ...
        <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
            <div class="form-group">
                <label for="proveedor">Comentario</label>
                ...
                <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
                    <table id="detalles" class="table table-striped table-bordered table-condensed table-hover">
                        ...
                        <tfoot>
                            ...
                            <tr>
                                <th colspan="4"><p align="right">IVA (21%):</p></th>
                                <th><p align="right">$. {{$venta->total_venta*$venta->impuesto/100}}</p></th>
                            </tr>
                            <tr>
                                <th  colspan="4"><p align="right">TOTAL A PAGAR:</p></th>
                              <!--  <th><p align="right">$. {{$venta->total_venta+($venta->total_venta*$venta->impuesto/100-$venta->impuesto/100)}}</p></th>-->
                                <th><p align="right">$. {{$venta->total_venta=($venta->total_venta+$venta->impuesto/100-$venta->impuesto/100)}}</p></th>
                            </tr>  
                        </tfoot>
                        <tbody>
