    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="{{url('home')}}" class="logo">
          ...
          <span class="logo-mini"><b>AMB</b></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>AMB Stock</b></span>
        </a>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <small class="bg-red">Usuario Online:</small>
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      SISTEMA DE GESTION PARA CONTROL DE STOCK         
          ...
          <ul class="sidebar-menu">
            ...
            <li id="liAlmacen" class="treeview">
              ...
              <ul class="treeview-menu">
                <li id="liCategorias"><a href="{{url('almacen/categoria')}}"><i class="fa fa-circle-o"></i> Rubros</a></li>
                <li id="liArticulos"><a href="{{url('almacen/articulo')}}"><i class="fa fa-circle-o"></i> Productos</a></li>
              </ul>
            </li>
            ...
            <li id="liCompras" class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li id="liIngresos"><a href="{{url('compras/ingreso')}}"><i class="fa fa-circle-o"></i> Compras</a></li>
              </ul>
            </li>
            ...
            <li id="liAcceso" class="treeview">
              <a href="#">
                <i class="fa fa-user"></i> <span>Accesos</span>
                <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
            ...
            <div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">Gestión de Stock</h3>
